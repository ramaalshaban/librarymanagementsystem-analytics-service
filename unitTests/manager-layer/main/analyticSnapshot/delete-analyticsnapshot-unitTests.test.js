...
describe("DeleteAnalyticSnapshot", () => {
  let ControllerClass;
  let req;
  ...
  beforeEach(() => {
    ...
    ControllerClass = proxyquire(
      "../../../../src/manager-layer/main/AnalyticSnapshot/delete-analyticsnapshot",
      {
  ...
  it("should initialize controller with correct base properties", () => {
    ...
    expect(instance.options.name).to.equal("deleteAnalyticSnapshot");
