...
describe("CreateAnalyticSnapshot", () => {
  let ControllerClass;
  let req;
  ...
  beforeEach(() => {
    ...
    ControllerClass = proxyquire(
      "../../../../src/manager-layer/main/AnalyticSnapshot/create-analyticsnapshot",
      {
  ...
  it("should initialize controller with correct base properties", () => {
    ...
    expect(instance.options.name).to.equal("createAnalyticSnapshot");
