...
describe("AnalyticsServiceManager", () => {
  ...
  beforeEach(() => {
    ...
    AnalyticsServiceManager = proxyquire(
      "../../../src/manager-layer/service-manager/AnalyticsServiceManager",
      {
  ...
  describe("userHasRole()", () => {
    it("should return true if userHasRole returns true", () => {
      ...
      const manager = new AnalyticsServiceManager(req, {});
