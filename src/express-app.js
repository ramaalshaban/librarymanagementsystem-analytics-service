...
const {
  ...
  analyticSnapshotRouter,
  auditLogRouter,
  changeStreamEventRouter,
} = require("restLayer");

app.use("", analyticSnapshotRouter);
app.use("", auditLogRouter);
app.use("", changeStreamEventRouter);
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(
    __dirname,
    "librarymanagementsystem-analytics-postman-collection.json",
  );
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="librarymanagementsystem-analytics-postman-collection.json"',
  );
