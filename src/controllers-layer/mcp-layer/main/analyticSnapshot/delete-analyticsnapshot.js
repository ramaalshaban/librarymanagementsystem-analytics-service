...
class DeleteAnalyticSnapshotMcpController extends AnalyticsMcpController {
  constructor(params) {
    super("deleteAnalyticSnapshot", "deleteanalyticsnapshot", params);
    this.dataName = "analyticSnapshot";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeleteAnalyticSnapshotManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: DeleteAnalyticSnapshotMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const deleteAnalyticSnapshotMcpController =
        new DeleteAnalyticSnapshotMcpController(mcpParams);
      try {
        const result =
          await deleteAnalyticSnapshotMcpController.processRequest();
        //return DeleteAnalyticSnapshotMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
