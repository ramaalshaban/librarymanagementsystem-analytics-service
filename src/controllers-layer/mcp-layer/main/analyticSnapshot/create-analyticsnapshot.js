...
class CreateAnalyticSnapshotMcpController extends AnalyticsMcpController {
  constructor(params) {
    super("createAnalyticSnapshot", "createanalyticsnapshot", params);
    this.dataName = "analyticSnapshot";
    this.crudType = "create";
  }

  createApiManager() {
    return new CreateAnalyticSnapshotManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: CreateAnalyticSnapshotMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const createAnalyticSnapshotMcpController =
        new CreateAnalyticSnapshotMcpController(mcpParams);
      try {
        const result =
          await createAnalyticSnapshotMcpController.processRequest();
        //return CreateAnalyticSnapshotMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
