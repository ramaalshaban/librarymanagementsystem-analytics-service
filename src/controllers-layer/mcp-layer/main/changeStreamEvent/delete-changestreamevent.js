...
class DeleteChangeStreamEventMcpController extends AnalyticsMcpController {
  constructor(params) {
    super("deleteChangeStreamEvent", "deletechangestreamevent", params);
    this.dataName = "changeStreamEvent";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeleteChangeStreamEventManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: DeleteChangeStreamEventMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const deleteChangeStreamEventMcpController =
        new DeleteChangeStreamEventMcpController(mcpParams);
      try {
        const result =
          await deleteChangeStreamEventMcpController.processRequest();
        //return DeleteChangeStreamEventMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",
