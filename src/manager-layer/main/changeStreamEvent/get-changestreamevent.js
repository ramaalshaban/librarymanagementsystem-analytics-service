...
const { dbGetChangestreamevent } = require("dbLayer");

class GetChangeStreamEventManager extends ChangeStreamEventManager {
  ...
  async doBusiness() {
    // Call DbFunction
    // make an awaited call to the dbGetChangestreamevent function to get the changestreamevent and return the result to the controller
    const changestreamevent = await dbGetChangestreamevent(this);
...
module.exports = GetChangeStreamEventManager;
