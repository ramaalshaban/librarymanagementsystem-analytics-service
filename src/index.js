...
console.log("Starting librarymanagementsystem-analytics-service service...");
...
const start = async () => {
  process.title = "node-librarymanagementsystem-analytics-service";
  ...
  try {
    ...
    await setRedisData(
      "librarymanagementsystem-analytics-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key librarymanagementsystem-analytics-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "librarymanagementsystem-analytics-service is listening HTTP/REST port " +
...
/* starting the server librarymanagementsystem-analytics-service .... */
start();
